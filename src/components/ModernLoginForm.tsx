      ...
      {/* Main Login Card */}
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-left flex-1">
                  ...
                  <div className={`text-xs ${themeMode === 'light' ? 'text-black' : 'text-white'}`}>Acceso limitado</div>
                </div>
                </div>
              </button>
            </div>
            ...
            <div className="mt-4 p-4 glass-effect rounded-2xl">
                             <div className={`text-xs space-y-1 ${themeMode === 'light' ? 'text-black' : 'text-white'}`}>
                 <div><span className="font-medium">Admin:</span> admin / admin123</div>
                 <div><span className="font-medium">Usuario:</span> user / user123</div>
               </div>
            </div>
          </div>
        </div>
